...
export const socialLinks = [
  {
    name: 'Github',
    link: 'https://github.com/naufalzp/',
  },
  {
    name: 'Linkedin',
    link: 'https://www.linkedin.com/in/naufalzhafifpradipta/',
  },
  {
    name: 'Instagram',
    link: 'https://www.instagram.com/naufal.zp/',
  },
];
...
export const description = {
  ...
  description:
    "I'm a Full Stack Web Developer, I love to build something that can help people.",
};
...
export const codeString = `const me = {
